...
Canonical path in code hive: `Z:\code\github.com\dev-centr\adapterhub`.
...
Run `pnpm dev:docs` and open http://localhost:3000/docs. The docs are also built and deployed by GitHub Actions (see `.github/workflows/docs.yml`).
